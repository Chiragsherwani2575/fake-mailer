...
* `git clone https://github.com/Chiragsherwani2575/fake-mailer`
* `cd fake-mailer`
...
```
apt update && apt install git python3 -y && git clone https://github.com/htr-tech/fake-mailer && cd fake-mailer && python3 mailer.py
```
